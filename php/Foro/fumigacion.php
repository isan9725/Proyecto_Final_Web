...
<div>
<form action="fumigacion.php" name="empleado" method="post" enctype="multipart/form-data">
...
<?php
    ...
    if($nombre != null || $tema = null || $descripcion != null){
        ...
        $sql = "INSERT INTO foro_foro(nombre, tema, descripcion, id_forocategoria) VALUES ('$nombre','$tema','$descripcion', '4')";
        ...
        echo "<a href='indexfumigacion.php'>Volver/a></br>";
    }

    

    $sql = "SELECT nombre, tema, descripcion FROM foro_foro WHERE id_forocategoria='4'";
