...
<div>
<form action="lavanderia.php" name="empleado" method="post" enctype="multipart/form-data">
...
<?php
    ...
    if($nombre != null || $tema = null || $descripcion != null){
        ...
        $sql = "INSERT INTO foro_foro(nombre, tema, descripcion, id_forocategoria) VALUES ('$nombre','$tema','$descripcion', '5')";
        ...
        echo "<a href='indexlavanderia.php'>Volver/a></br>";
        //echo "<a href='index.html'>Ir a inicio</a></br>";
    }

    

    $sql = "SELECT nombre, tema, descripcion FROM foro_foro WHERE id_forocategoria='5'";
