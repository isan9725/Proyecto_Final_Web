                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    <!--Lo mismo que el de busqueda_registrados revisar si carga otra vez el href -->
                                    <li>
                                        <a href="?categoria=fumigaciones">Fumigaciones</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=niniera">Niñera</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=lavanderia">Lavanderia</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=podado">Podado de Cesped</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=decoracion">Decoración de Interiores</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=asesorias">Asesorías</a>
                                    </li>
                                    <li>
                                        <a href="?categoria=ayudas">Ayudas</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
